function [obj_val, x_val, y_val] = solve_project_mgt_sldr(C, beta, W, H, a, b, c, z_pos_mean)

% 
% +ROMETEST\SOLVE_PROJECT_MGT_SLDR Helper routine to solve
% project management example using a segregated linear decision rule
%
%   [obj_val, x_val, y_val] = SOLVE_PROJECT_MGT_SLDR(C, beta, W, H, a, b, c)
...
rome_begin;
h = rome_model('Project Management Example - SLDR');
...
% w = rome_linearrule(num_edges, z, 'Cone', rome_constants.NNOC);
